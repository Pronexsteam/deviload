...
| Симптом | Что делать |
|---|---|
| `HTTP Error 403`, «Sign in to confirm you're not a bot», «видео приватное» | Нажмите **Войти в YouTube** (см. выше). Если вход уже выполнен, а ошибка осталась — выйдите и войдите заново: сессия могла истечь. |
| «This content is age-restricted» при выполненном входе | YouTube просит аккаунт подтвердить возраст. Сделайте это на youtube.com в обычном браузере, потом в Deviload выйдите и войдите заново. |
